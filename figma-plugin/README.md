...
The plugin creates one Figma page named **Orange Nelumbo · Full Website**, containing 27 separate top-level frames arranged in a three-column canvas. The two additional frames are the new public demo destinations:
...
- Learning pages: Learning Home, Visual Notes, Subject, Chapter, Simulations, Simulation Detail, Bookmarks, Notifications, Profile, Settings, and the Protected Note Reader.
...
The importer uses Hanken Grotesk as the primary website font and DM Sans for learning surfaces and fallback coverage, with Inter as the final Figma-safe fallback.

...
const plans = [
  ...
  { name: "Complete Library", price: "₹9,999", copy: "The complete notes and simulations collection, organised into guided visual sequences.", features: ["Everything in Notes + Simulations", "Curated concept maps", "Educator-curated sequences", "All library additions this year"] },
];

...
import { ArrowRight, BookOpen, FlaskConical, PlayCircle, UserRound } from "lucide-react";

import { MarketingFooter } from "@/components/layout/marketing-footer";
import { MarketingHeader } from "@/components/layout/marketing-header";

export const metadata: Metadata = { title: "Help centre", description: "Help with Orange Nelumbo notes, simulations, videos, and accounts." };
...
const topics = [
  ...
  [PlayCircle, "Video lectures", "Video lectures are planned for a future release. The current demo does not claim that the video library is available."],

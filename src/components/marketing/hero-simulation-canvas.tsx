  ...
  return (
    <div className="home-simulation-canvas brand-grid" role="img" aria-label="Looping previews of interactive science and mathematics simulations">
      ...
      <div className="grid gap-px bg-white/8 sm:grid-cols-2">
        ...
        <div className="relative min-h-56 overflow-hidden bg-[#0E0D10]/96 p-5">
          <div className="flex items-center justify-between"><p className="text-[11px] font-medium text-[#3DE0D0]">Waves</p><Waves size={17} className="text-[#3DE0D0]" /></div>
        ...
        <div className="relative min-h-52 overflow-hidden bg-[#0E0D10]/96 p-5">
          <div className="flex items-center justify-between"><p className="text-[11px] font-medium text-[#3DE08A]">Calculus</p><Orbit size={17} className="text-[#3DE08A]" /></div>
      ...
      <div className="flex items-center gap-4 border-t border-white/9 px-5 py-3">
        <FlaskConical size={15} className="shrink-0 text-[#FF8A3D]" />
        <p className="text-xs text-[#C7C5CC]/70">Physics, Chemistry, and Mathematics in motion.</p>
      </div>
    </div>
  );
}
